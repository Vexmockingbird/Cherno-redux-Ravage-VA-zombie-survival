...
diag_log "//________________ GF_AEW_Sounds_SFX_Forest initialized ________________";


if (GF_AEW_Systemchat_info) then {
systemchat "GF_AEW_Sounds_SFX_Forest initialized";			
};	


//________________ GF_AEW_Sounds_SFX_Forest ________________

GF_AEW_Sounds_SFX_Forest_Spawn = {


if (GF_AEW_Systemchat_info) then {
systemchat "GF_AEW_Sounds_SFX_Forest";			
};	
...
hintsilent "nightime";		
	...
	sleep GF_AEW_Sounds_SFX_Forest_Loop;
...
if (GF_AEW_hintsilent_info) then {
hintsilent "GF_AEW_Sounds_SFX_Forest";	
};	
...
for "_x" from 0 to GF_AEW_Sounds_SFX_Forest_Spawn_x_Number do {
[]spawn GF_AEW_Sounds_SFX_Forest_Spawn;
};