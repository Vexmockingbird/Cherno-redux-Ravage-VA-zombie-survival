...
diag_log "//________________ GF_AEW_Sounds_Wind initialized ________________";


if (GF_AEW_Systemchat_info) then {
systemchat "GF_AEW_Sounds_Wind initialized";			
};	


//________________ GF_AEW_Sounds_Wind ________________

GF_AEW_Sounds_Wind_Spawn = {


if (GF_AEW_Systemchat_info) then {
systemchat "GF_AEW_Sounds_Wind";			
};	
...
for "_x" from 0 to GF_AEW_Sounds_Wind_Spawn_x_Number do {
[]spawn GF_AEW_Sounds_Wind_Spawn;
};