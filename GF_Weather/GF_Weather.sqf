...
GF_Weather_Debug							= false;
GF_Weather_systemchat_info					= false;

GF_Weather_setDate							= false;
...
GF_Weather_Overcast_Value 					= selectrandom [
											0.1,0.2,0.3,		//	No snow below 0.3
											0.4,0.5,0.6,0.7];	//	More than 0.7 to rain

GF_Weather_Overcast_Loop 					= 900;

GF_Weather_Fog 								= true;
GF_Weather_Time_to_setFog 					= 120;
