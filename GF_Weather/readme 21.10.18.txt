...
GF Weather Script , simple and configurable to set your desired values.
...
For usage instructions and information of how to use the GF Weather Script please refer to the included documentation and/or example mission.
...
Simple and configurable to set your desired values.
...
Forum topic:
- BI forums https://forums.bohemia.net/forums/topic/219922-gf-weather-script/
- Armaholic forums http://www.armaholic.com/forums.php?m=posts&q=40261 
