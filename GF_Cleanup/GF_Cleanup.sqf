...
_Delete_distance				= 250;	//	Meters distance from Players to delete the items
...
sleep 300;	//	set the time , in how many second to delete again , if you select to be on continuous (loop)
...
//________________ _10_Destructed_Vehicles _____________	
...
//________________ _11_EmptyDetector_MP_triggers _____________	
...
//________________ _12_Plane_Parts _____________	
...
//________________ _13_Destruction_Crater _____________	it's not working!
